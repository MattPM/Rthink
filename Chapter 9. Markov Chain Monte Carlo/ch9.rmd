...
The metropolis is the "grandparent" of other strategies 
...
### issue wit hgibbs sampling

issue- correlations in parameter values form narrow valleys. metropolis and gibbs get stuck because they dont know enought about the shape of the distribution (the posterior).
