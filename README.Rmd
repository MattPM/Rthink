...
This repository contains my own personal notes and code following Richard Mcelreath's text "Statistical Rethinking Bayesian Statistics with R and stan". These notes are public but are for my own personal reference and are not endorsed by anyone other than myself. 
